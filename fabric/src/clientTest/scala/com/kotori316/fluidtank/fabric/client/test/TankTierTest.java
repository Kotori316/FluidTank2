...
public final class TankTierTest implements FluidTankClientGameTest {
    ...
    public void runTest(ClientGameTestContext context, TestSingleplayerContext singlePlayerContext) {
        ...
        Stream.of(Tier.values())
            ...
            .forEach(tier -> {
                testTierLevels(this, context, singlePlayerContext, "water", FluidAmountUtil.BUCKET_WATER(), tier);
                testTierLevels(this, context, singlePlayerContext, "lava", FluidAmountUtil.BUCKET_LAVA(), tier);
            });
        testTierLevels(this, context, singlePlayerContext, "water", FluidAmountUtil.BUCKET_WATER(), Tier.CREATIVE);
        testTierLevels(this, context, singlePlayerContext, "lava", FluidAmountUtil.BUCKET_LAVA(), Tier.CREATIVE);
    }
    ...
    static void testTierLevels(FluidTankClientGameTest testInstance, ClientGameTestContext context,
                               ...
                               GenericAmount<FluidLike> fluid, Tier tier) {
